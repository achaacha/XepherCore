...
namespace XepherBot.Modules
{
    public abstract class XepherTopLevelModule : ModuleBase
    {
        ...
        public XepherStrings Strings { get; set; }
        ...
        protected XepherTopLevelModule(bool isTopLevelModule = true)
        {
        ...
        //{
        //    var title = XepherBot.ResponsesResourceManager.GetString(titleKey, cultureInfo);
        //    var text = XepherBot.ResponsesResourceManager.GetString(textKey, cultureInfo);
    ...
    public abstract class XepherTopLevelModule<TService> : XepherTopLevelModule where TService : INService
    {
        public TService _service { get; set; }

        protected XepherTopLevelModule(bool isTopLevel = true) : base(isTopLevel)
        {
        }
    }

    public abstract class XepherSubmodule : XepherTopLevelModule
    {
        protected XepherSubmodule() : base(false) { }
    }

    public abstract class XepherSubmodule<TService> : XepherTopLevelModule<TService> where TService : INService
    {
        protected XepherSubmodule() : base(false)
        {
        }
