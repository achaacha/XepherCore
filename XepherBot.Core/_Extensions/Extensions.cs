...
using XepherBot.Common;
using XepherBot.Common.Collections;
using XepherBot.Core.Services;
using XepherBot.Modules.Administration.Services;
...
namespace XepherBot.Extensions
{
    public static class Extensions
    {
        ...
        public static EmbedBuilder WithOkColor(this EmbedBuilder eb) =>
            eb.WithColor(XepherBot.OkColor);

        public static EmbedBuilder WithErrorColor(this EmbedBuilder eb) =>
            eb.WithColor(XepherBot.ErrorColor);
